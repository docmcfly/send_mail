...
namespace Cylancer\SendMessage\Controller;
...
use Cylancer\SendMessage\Domain\Model\ValidationResults;
...
use Cylancer\SendMessage\Service\EmailSendService;
use Cylancer\SendMessage\Service\FrontendUserService;
 ...
 *
 * @package Cylancer\SendMessage\Controller
 */
class MessageFormController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{

    const EXTENSION_NAME = 'SendMessage';

    const TX_EXTENSION_NAME = 'tx_send_message';
